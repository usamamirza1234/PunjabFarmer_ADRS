...
public class DModel_FarmerAnimalIntimateDisease {
    String longitude;
    String latitude;
    String diseaseID;
    String tehsil;
    ...
    String sickAnimals;
    String deadAnimals;
    String sickAnimalImage;
    String farmId;
    String diseaseIntimationID;
    String reportID;
    String farmerID;
    String cnic;
    String mobileNumber;
    ...
    public String getAnimalIndex() {
        return animalIndex;
    }

    public void setAnimalIndex(String animalIndex) {
