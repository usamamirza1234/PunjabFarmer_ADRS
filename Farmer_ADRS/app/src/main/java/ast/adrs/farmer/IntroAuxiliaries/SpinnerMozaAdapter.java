...
public class SpinnerMozaAdapter extends BaseAdapter {
    Context context;
    ...
    public SpinnerMozaAdapter(Context context, List<DModel_District> listData) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflter.inflate(R.layout.adapter_spinner_mozah_item_list, null);
...
//        }
        ...
        if (!listData.get(position).getName().equalsIgnoreCase(context.getString(R.string.select_mozah)))
        ...
        else
        {
            ...
            {
                viewHolder.txtName.setText("Select Mouza");
            }
            else   viewHolder.txtName.setText("موضع کا انتخاب کریں");
        }
