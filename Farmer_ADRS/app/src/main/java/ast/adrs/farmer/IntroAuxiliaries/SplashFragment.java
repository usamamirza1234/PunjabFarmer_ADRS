...
//                    getActivity().finish();
    ...
    public void navToSignInFarmerFragment() {
        SignInFarmerFragment frg = new SignInFarmerFragment();
        FragmentManager fm = getFragmentManager();
        FragmentTransaction ft = fm.beginTransaction();
        ft.replace(R.id.act_intro_content_frg, frg, AppConstt.FragTag.FN_SignInFarmerFragment);
//        ft.addToBackStack(AppConstt.FragTag.FN_SignInFarmerFragment);
//        ft.hide(this);
        ft.commit();
